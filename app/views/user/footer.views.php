        ...
        <div class="row mt-3">
          ...
          <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <hr
                ...
                />
            <p>
              <a href="#!" class="text-white">Chăm sóc da</a>
            </p>
            <p>
              <a href="#!" class="text-white">Trang điểm</a>
            </p>
            <p>
              <a href="#!" class="text-white">Chăm sóc cơ thể</a>
            </p>
            <p>
              <a href="#!" class="text-white">Chăm sóc móng</a>
            </p>
          </div>
          <!-- Grid column -->
          ...
          <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
            ...
            <p>
              <a href="#!" class="text-white">Trở thành tiếp thị</a>
            </p>
            <p>
              <a href="#!" class="text-white">Chất lượng giao hàng</a>
            </p>
            <p>
